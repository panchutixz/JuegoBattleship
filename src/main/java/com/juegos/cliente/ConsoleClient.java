...
public class ConsoleClient {
    ...
    public void start() {
        System.out.println("================================================");
        System.out.println("      BATTLESHIP - VERSIÓN CONSOLA");
        System.out.println("================================================");
    ...
    private void connectToServer() {
        ...
        if (address.trim().isEmpty()) {
            address = "localhost"; // Valor por defecto de localhost
        }

        System.out.print("Puerto del servidor (5432): ");
        String portStr = scanner.nextLine();
        int port = 5432; // Puerto por defecto
        if (!portStr.trim().isEmpty()) {
            try {
                port = Integer.parseInt(portStr.trim());
            } catch (NumberFormatException e) {
                System.out.println("Puerto inválido, usando 5432");
            }
        }
